...
describe('core --- bingoJS ' + bingo.version , function () {
    ...
    describe('using', function () {
        ...
        it('using', function () {
            ...
            bingo.using('spec/using/a.js', function () {
    ...
    describe('bingo.route ======>', function () {
        ...
        it('bingo.route', function () {
            ...
            expect(bingo.route(routeUrl)).toEqual('spec/route/sys_user.js?id=1');
            ...
            //测试myTest
            expect(bingo.route('myTest/sys/user/1')).toEqual('spec/route/sys_user_test.js?id=1');
            expect(bingo.route('myTest111/sys/user/1')).toEqual('spec/route/sys_user_test.js?id=1');
            ...
            bingo.route('test_all', {
                ...
                priority: 200,
                url: 'view/{module}/{action*}_{md5}',
                //路由到目标url, 生成:modules/system/views/user/list.html
                toUrl: 'modules/{module}/{action*}_{md5}.html'
            });

            var tContext = bingo.routeContext('view/command/renderSync/ddddd/test_aasdf$id:11111');
            expect(tContext.params.module).toEqual('command');
            expect(tContext.params.action).toEqual('renderSync/ddddd/test');
